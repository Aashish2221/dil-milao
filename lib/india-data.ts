export const INDIA_DATA: Record<string, string[]> = {
  "Andhra Pradesh": [
    "Anakapalli","Ananthapuramu","Bapatla","Chittoor","East Godavari","Eluru",
    "Guntur","Kadapa","Kakinada","Konaseema","Krishna","Kurnool","Nandyal",
    "Nellore","Palnadu","Parvathipuram Manyam","Prakasam","Srikakulam",
  ...
  "Arunachal Pradesh": [
    ...
    "Lower Siang","Lower Subansiri","Namsai","Papum Pare","Siang","Tawang",
  ...
  "Nagaland": [
    ...
    "Niuland","Noklak","Peren","Phek","Tuensang","Wokha","Zunheboto"
  ],
  "Odisha": [
  ...
  "Uttar Pradesh": [
    ...
    "Lakhimpur Kheri","Lalitpur","Lucknow","Mahoba","Mahrajganj","Mainpuri",
...
export function getDistricts(state: string): string[] {
  return (INDIA_DATA[state] || []).slice().sort();
}
